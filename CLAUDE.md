...
**現状の在庫調査(2026-07-23実施)** — `install.sh`/`install.ps1`/
`.github/workflows/release.yml`の有無をF:\runo配下の全Gitリポジトリで
確認:

| 揃っている(3点セット) | install.sh/ps1のみ(release.yml無し) | 未着手 |
|---|---|---|
| RPoem, RS-Blog, RS-EC, RS-Git, RS-LinkFusion, RS-Red, open-web-server | RS-Guard, RS-Ops, rs-sync | RCosmo(release.ymlのみ), RFrontEnd, RS-JSON, RS-SmartTCP, **aruaru-db**, aruaru-llm, aruaru.tokyo, audiocafe-tokyo-php/rust, e-gov.info, karu.tokyo, open-cuda, open-easy-web, **open-raid-z**, rs-gitbucket, rs-to-readme, runo-scanner, runo.tokyo |
