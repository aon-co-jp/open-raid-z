...
use openzfs_winfsp_bridge::block_device::{BlockDevice, FaultInjectableDevice, FileBackedDevice};
...
fn scratch_dir(name: &str) -> PathBuf {
    let dir = std::env::temp_dir().join(format!("openruno_raid_series_it_{name}_{}", std::process::id()));
